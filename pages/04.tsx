...
function Before() {
  ...
  return (
    <Flex bg='gray' alignItems="center" justifyContent="center" w="full" height="full">
      {
        page === "app" && <Flex w="full" h="full" bg="black">
          <Button onClick={() => setPage('thankyou')} m="auto">Finish App</Button>
        </Flex>
      }
       {
...
function After() {
  ...
  return (
    <Flex bg='gray' alignItems="center" justifyContent="center" w="full" height="full" position="relative">
      <animated.div style={{ width: style.size, height: style.size, overflow: 'hidden', position: 'absolute'}}>
